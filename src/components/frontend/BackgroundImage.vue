<template>
  <div class="fixed inset-0 -z-10 overflow-hidden">
    ...
    <div
      ...
      style="background: radial-gradient(circle, rgba(147, 145, 255, 0.55), transparent 65%)"
    ></div>
    <div
      class="absolute -bottom-56 -right-40 w-[42rem] h-[42rem] rounded-full opacity-30 blur-[100px]"
      style="background: radial-gradient(circle, rgba(56, 189, 248, 0.5), transparent 65%)"
    ></div>
